...
#define ls_subsidy(from_rg,to_rg) ((((from_rg) == 4 || (from_rg) == 5) && !((to_rg) == 4 || (to_rg) == 5)) ? -61000.0f : \
                                  (((to_rg) == 4 || (to_rg) == 5) && !((from_rg) == 4 || (from_rg) == 5)) ? 59000.0f : 0.0f)
#else
#define EMAX(t,k,from_h_rg,h_rg,w_rg,state,dwage) 0
#endif
